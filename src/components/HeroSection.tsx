...
export const HeroSection = () => {
  ...
  return (
    <section
      className="min-h-screen flex flex-col relative overflow-hidden bg-cover bg-center bg-no-repeat bg-scroll md:bg-fixed"
      style={{
    ...
    >
      ...
      {/* Navigation */}
      <nav className="relative z-20 px-6 md:px-12 lg:px-24 pt-8">
      ...
      {/* Hero Content */}
      <div className="flex-1 flex items-center justify-center relative z-20 px-6 md:px-12 pt-4 md:pt-16 lg:pt-20">
        <div className="container mx-auto text-center max-w-4xl">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-extrabold mb-6 md:mb-8 leading-[1.05] tracking-tight">
          ...
          <p className="text-lg md:text-xl lg:text-2xl mb-10 md:mb-12 text-[hsl(215,12%,65%)] max-w-3xl mx-auto leading-relaxed font-normal">
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 text-sm text-[hsl(215,10%,45%)]">
