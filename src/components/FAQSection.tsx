...
export const FAQSection = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: "Chamadas ao vivo com Arthur e Lyria. É só. O sistema completo está 100% presente — e essa é justamente a razão do preço ser R$ 997 e não R$ 2.997. Você acessa o sistema completo sem o custo do tempo pessoal dos fundadores. Para quem executa, isso é VANTAGEM: sem fila, sem agenda, sem depender de ninguém."
    },
    {
    ...
    },
    {
      ...
      answer: "Essa é exatamente a razão pela qual seu acesso inclui 1 ano de atualizações. Sempre que testamos e validamos um novo agente ou automação na nossa própria operação, adicionamos ao conteúdo da formação. Você não está comprando um curso estático — está comprando acesso a um sistema vivo que evolui com a tecnologia. E os fundamentos de automação, agentes e workflows que ensinamos nos primeiros módulos não mudam com as tendências. São a base que funciona independente de qual ferramenta está na moda."
    },
    {
      question: "Em quanto tempo recupero os R$ 997?",
      answer: "Se você implementar apenas UMA automação do Módulo 6 — um chatbot de recuperação de leads, por exemplo — e ela gerar UMA venda extra por semana, o sistema se paga no primeiro mês. Nossos alunos mais rápidos aplicaram o conteúdo nas primeiras 2 semanas. Os mais empreendedores começaram a vender projetos de automação para outras empresas com ticket que pagou a formação várias vezes."
    },
    {
