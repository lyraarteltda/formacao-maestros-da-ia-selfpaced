      ...
      <div className="container mx-auto relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-center gap-2 md:gap-6 text-center">
          ...
          <div className="flex items-center gap-2 text-xs md:text-sm">
            ...
            <span className="opacity-75">• 15 de setembro</span>
          </div>
          
          {/* Pricing - inline */}
          <div className="flex items-center gap-3 text-xs md:text-sm">
            <span className="font-bold text-green-300">Lançamento: R$ 1.500</span>
            <span className="opacity-75">vs</span>
            <span className="line-through opacity-75">Oficial: R$ 5.000</span>
          </div>
          
          {/* WhatsApp message - compact */}
          <div className="text-xs opacity-90 max-w-xs md:max-w-none">
            Garanta o preço entrando no grupo pelos botões abaixo.
          </div>
        </div>
      </div>
    </div>
