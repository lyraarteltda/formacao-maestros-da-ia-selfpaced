...
import { Check, Users, Calendar, Bot, GraduationCap, Award, MoreHorizontal, MessageCircle, Crown } from "lucide-react";
...
export const PricingSection = () => {
  ...
  const features = [
    { icon: Calendar, text: "Acesso Anual" },
    { icon: GraduationCap, text: "Formação Completa" },
    { icon: Users, text: "Comunidade Exclusiva" },
    { icon: Bot, text: "Suporte Técnico IA e Automações" },
    { icon: Award, text: "Mentoria de Negócios" },
    { icon: MoreHorizontal, text: "Muito Mais..." },
  ];

  return (
    <section className="section-padding bg-card" data-section="pricing">
      <div className="container mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4 text-center leading-tight">
            ...
            <br />
            <span className="gradient-text">Condição Exclusiva para Membros Fundadores</span>
          </h2>
        </div>
          ...
          <div className="bg-gradient-primary p-1 rounded-xl shadow-glow">
            <div className="bg-background rounded-lg p-6 md:p-8 text-center">
              ...
              <div className="mb-6 -mt-2 animate-[fade-in_0.5s_ease-out,scale-in_0.5s_ease-out]">
                <div className="relative overflow-hidden bg-gradient-to-r from-amber-500 via-yellow-500 to-amber-600 text-black font-bold px-4 py-2 rounded-lg text-sm md:text-base shadow-xl border-2 border-amber-300 hover:scale-105 transition-transform duration-300">
                  ...
                  <div className="text-center space-y-2">
                    <div className="flex items-center justify-center gap-2">
                      ...
                      <p className="text-foreground font-medium text-sm md:text-base">
                        Resta apenas <span className="text-primary font-bold">1 vaga</span> de Membro Fundador
                      </p>
                      <div className="w-1.5 h-1.5 rounded-full bg-primary animate-pulse"></div>
                    </div>
                    <p className="text-muted-foreground text-xs md:text-sm">
                      Valor sobe para R$ 5.000 ao atingir 100 membros
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-8 space-y-6">
                <div className="text-center space-y-4">
                  <div className="text-lg text-muted-foreground">
                    De <span className="line-through text-red-500 font-semibold text-2xl">R$ 5.000</span> por apenas
                  </div>
                  <div className="text-2xl font-medium text-muted-foreground">12x de</div>
                  <div className="text-5xl md:text-6xl font-black text-foreground leading-none">R$ 323</div>
                </div>
              ...
              <div className="space-y-4 mb-8">
                {features.map((feature, index) => (
                  <div key={index} className="flex items-center flex-row text-left">
