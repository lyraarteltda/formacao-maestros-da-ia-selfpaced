      ...
      <div className="container mx-auto max-w-lg">
          ...
          <div className="relative bg-card border border-emerald-500/20 rounded-3xl overflow-hidden">
            ...
            <div className="p-4 sm:p-6 md:p-8">
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-5xl sm:text-6xl md:text-7xl font-black text-emerald-400 font-mono mb-2">
                  R$ 997
                </p>
            ...
            <div className="border-t border-border/50 px-4 sm:px-6 md:px-8 py-4 sm:py-5 flex flex-wrap items-center justify-center gap-3 sm:gap-4">
        ...
        <div className="flex justify-center mt-6">
          <Button
            ...
            variant="outline"
            size="lg"
            className="gap-2 w-full sm:w-auto min-h-[44px] border-border/50 text-[hsl(215,12%,65%)] hover:text-emerald-400 hover:border-emerald-500/30 transition-all duration-300"
          >
