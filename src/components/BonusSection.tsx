export const BonusSection = () => {
  return <section className="section-padding bg-gradient-primary text-primary-foreground">
      <div className="container mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 animate-fade-in hover-scale">
            <span className="gradient-text tracking-wider drop-shadow-lg">OS MAESTROS</span>
          </h2>
        </div>

        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 lg:gap-20 items-center md:items-start">
            ...
            <div className="order-1 lg:order-2 md:pl-6">
              <img src="/lovable-uploads/f3b2c877-3564-40ef-8dab-1ee449dbc40a.png" alt="Casal por trás do Maestros da IA" className="w-full h-auto rounded-2xl shadow-lg md:max-w-xl lg:max-w-sm md:mx-auto" />
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mt-16">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
              <h3 className="text-2xl font-bold text-white mb-2">Lyria Zoccal</h3>
              <p className="text-lg text-white/90 mb-6">Co-Fundadora Lyra Academy e Maestria Academy | Especialista em IA e Automação</p>
            ...
            {/* Arthur Endo */}
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
              <h3 className="text-2xl font-bold text-white mb-2">Arthur Endo</h3>
              <p className="text-lg text-white/90 mb-6">Co-Fundador Lyra Academy e Maestria Academy | Especialista em IA e Automação</p>
              <ul className="space-y-3 text-white/80">
                <li className="flex items-start">
                  <span className="mr-2">•</span>
